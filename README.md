...
🎯 **Sobre mim**
Sou formado em **Segurança da Informação** e pós-graduando em **Inteligência Artificial e Aprendizado de Máquina**. Tenho experiência em **planejamento de produção (PCP)**, **automação de relatórios com Python** e **análise de dados**. 
