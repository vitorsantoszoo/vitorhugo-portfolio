...
| Arquivo | Descrição |
|---------|-----------|
| [Atividade 1](./Atividade%201.ipynb) | Exploração inicial de dados e métricas básicas |
| [Atividade 2](./Atividade%202.ipynb) | Visualização analítica e comparativos gráficos |
| [Atividade 3](./Atividade%203.ipynb) | Introdução a ML supervisionado (scikit-learn) |
| [Exercício – Regressão Linear](./Exerc%C3%ADcio%20Regress%C3%A3o%20Linear.ipynb) | Construção de modelo de Regressão Linear em Python |
